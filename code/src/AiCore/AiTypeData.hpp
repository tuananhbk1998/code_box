...
#define DIR_MODEL_OBJECTDETECION_NCNN "../models/" // G1
#define DIR_LABEL_OBJECTDETECION_NCNN "../models/" // G1

#define DIR_MODEL_OBJECTDETECION_SNPE "../models/" // G2
#define DIR_LABEL_OBJECTDETECION_SNPE "../models/" // G2
