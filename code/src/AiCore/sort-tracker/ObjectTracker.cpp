...
void ObjectTracker::update_scale_wh_anpr_VN(vector<ObjectTrace> detected, float scale_w_rect, float scale_h_rect, float scale_w_square, float scale_h_square)
{   
    vector<Rect_<float>> detectedBox;
    vector<Rect_<float>> detectedBoxScale; // 
    for(auto det : detected) {
